...
app.get(oUserServicePrefix+'/getLoginUserMenu',oUserService.getLoginUserMenu);
...
app.get(oExpenseServicePrefix+'/getExpenseListsbyUser',oExpenseService.getExpenseListsbyUser);
